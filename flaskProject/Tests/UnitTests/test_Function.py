...
class MyTestCase(unittest.TestCase):
    ...
    def testLog(self):
        ...
        self.assertIn("{-6x+7}{-3x^2+7x-4}", app.deriveString(p, c=c, b=b)) #y'=\frac{-6x+7}{-3x^2+7x-4}
    ...
    def testTan(self):
        ...
        self.assertIn("{-6x+7}{cos^2(-3x^2+7x-4)}", app.deriveString(p, c=c, b=b))#y'=\frac{-6x+7}{cos^2(-3x^2+7x-4)}
    ...
    def testCot(self):
        ...
        self.assertIn("{-6x+7}{sin^2(-3x^2+7x-4)}", app.deriveString(p, c=c, b=b)) #y'=-\frac{-6x+7}{sin^2(-3x^2+7x-4)}
        self.assertEqual("אין נקודות קיצון", str(app.make_extreme_question(b, c, p)[2]))
    ...
    def testRoot(self):
        ...
        self.assertIn("{-6x+7}{2\sqrt{-3x^2+7x-4}}", app.deriveString(p, c=c, b=b)) #"y'=\frac{-6x+7}{2\sqrt{-3x^2+7x-4}}
